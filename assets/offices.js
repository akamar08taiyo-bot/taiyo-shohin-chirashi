// 太陽シルバーサービス㈱ 全19営業所マスタ（出所: taiyo-office-master スキル）
const TSS_OFFICE_MASTER = [
  ...
  { name: '久留米営業所', zip: '838-0814', address: '福岡県朝倉郡筑前町高田585-1', tel: '0946-21-5355', fax: '0946-21-5356', manager: '牟田 知広' },
  ...
  { name: '大分営業所', zip: '870-0142', address: '大分県大分市三川下2-7-8', tel: '097-555-9684', fax: '097-555-9685', manager: '山下 厚' },
];
